...
public class AddOrEditEventOnClickDay extends MouseAdapter {

    private final EventKeeper events;

    public AddOrEditEventOnClickDay(EventKeeper ek) {
        super();
        this.events = ek;
    }
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if (e.getClickCount() == 2) {
            ...
            List<Event> eventsForDay = events.getEventsForDay(button.getCurrentDate().getTime());
